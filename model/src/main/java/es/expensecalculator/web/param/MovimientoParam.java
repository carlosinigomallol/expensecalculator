 ...
 */
public class MovimientoParam extends ParamCommun implements EntityParam<MovimientoParam>, Serializable {
	...
	@Override
	public MovimientoParam getEntityParam() {
		return this;
	}
