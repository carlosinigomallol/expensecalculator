 ...
 */
@ManagedBean(name = "movimientoConverter")
@RequestScoped
@FacesConverter(value = "movimientoConverter")
public class MovimientoConverter implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent comp, String value) {
        if (value != null && !"".equals(value)) {
            try {
                Long movimientoid = Long.parseLong(value);
    ...
    public String getAsString(FacesContext facesContext, UIComponent comp, Object value) {
        ...
        if (value instanceof Movimiento) {
            Long key = ((Movimiento) value).getId();
